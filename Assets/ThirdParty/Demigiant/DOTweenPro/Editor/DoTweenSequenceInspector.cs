...
{
    public class DOTweenSequenceInspector
    {
        enum FadeTargetType
        {
            CanvasGroup,
        ...
        DOTweenSequenceComponent _mono;
...
#pragma warning restore 414
        ...
        public void OnEnable(DOTweenSequence target, DOTweenSequenceComponent mono)
        {
            _src = target;
            _mono = mono;
        ...
        public void OnInspectorGUI(bool isAppend = false)
        {
            if (!isAppend)
            {
                ...
                else
                {
                    ...
                    {
                        _src.isValid = false;
                        if (GUI.changed) EditorUtility.SetDirty(_mono);
                        return;
                    }
                    ...
                    switch (_src.animationType)
                    {
                        ...
                        case DOTweenAnimationType.Rotate:
                        case DOTweenAnimationType.LocalRotate:
                            bool isRigidbody2D = DOTweenModuleUtils.Physics.HasRigidbody2D(_mono);
