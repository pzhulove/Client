...
namespace DG.Tweening
{
    ...
    /// </summary>
    [Serializable]
    public class DOTweenSequence:ABSAnimationSequenceComponent
    {
        public DOTweenSequence(GameObject gameObject)
        {
...
/*
            ...
            if (tween != null && tween.IsInitialized()) tween.Rewind();
        }
        ...
        //{
        //    DOTweenSequence[] anims = this.GetComponents<DOTweenSequence>();
        //    while (_playCount < anims.Length - 1) {
        //        _playCount++;
        //        DOTweenSequence anim = anims[_playCount];
...
//            return DOTween.TweensByTarget(this.gameObject);
            ...
            //DOTweenSequence[] anims = this.GetComponents<DOTweenSequence>();
            //foreach (DOTweenSequence anim in anims) result.Add(anim.tween);
            //return result;
       // }
        ...
        public Tween CreateSequenceTween()
        {
            CreateTween();
            return tween;
        }
    ...
    public abstract class ABSAnimationSequenceComponent
    {
        ...
        //     Set it to TRUE when spawning the same DOTweenPath in different positions (like
        //     when using a pooling system)
