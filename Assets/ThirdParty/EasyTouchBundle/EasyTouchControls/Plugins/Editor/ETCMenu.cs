...
public static class ETCMenu{
	...
	static void  AddButton(){
		...
		button.GetComponent<ETCButton>().coolDownSprite = GetSpriteByName("ETCButtonPressed",sprites);
		button.GetComponent<ETCButton>().coolDownColor = new Color(1.0f,1.0f,1.0f,0.5f);

		button.GetComponent<ETCButton>().fgSprite = GetSpriteByName("ETCButtonPressed",sprites);
		button.GetComponent<ETCButton>().fgColor = new Color(1.0f,1.0f,1.0f,1.0f);
