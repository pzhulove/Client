...
{
    [CustomEditor(typeof(TextLayoutElement), true)]
    [CanEditMultipleObjects]
    public class TextLayoutElementEditor : Editor
    {
        ...
        SerializedProperty m_verticalMode;
        SerializedProperty m_horizontalMode;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_horizontalMode, true);
            EditorGUILayout.PropertyField(m_verticalMode, true);
        ...
        void LayoutElementField(SerializedProperty property, System.Func<RectTransform, float> defaultValue)
        {
            ...
            if (EditorGUI.EndChangeCheck())
            {
                ...
                property.floatValue = (enabled ? defaultValue((target as TextLayoutElement).transform as RectTransform) : -1);
            }
