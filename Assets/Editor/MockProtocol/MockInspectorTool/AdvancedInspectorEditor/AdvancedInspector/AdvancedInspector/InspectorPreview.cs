    ...
    public class InspectorPreview
    {
        ...
        private static void InitPreview()
        {
            ...
            if (previewUtility == null)
            {
                ...
                previewUtility.m_CameraFieldOfView = 30f;
                previewUtility.m_Camera.cullingMask = -2147483648;
        ...
        private static void DoRenderPreview()
        {
            ...
            previewUtility.m_Camera.transform.position = vector;
            previewUtility.m_Camera.transform.rotation = quaternion;
            previewUtility.m_Camera.nearClipPlane = view - (extends * 1.1f);
            previewUtility.m_Camera.farClipPlane = view + (extends * 1.1f);

            if (light == 0)
            {
                previewUtility.m_Light[0].intensity = 0.5f;
                previewUtility.m_Light[0].color = new Color(0.7f, 0.6f, 0.4f);
                previewUtility.m_Light[0].transform.rotation = quaternion * Quaternion.Euler(30, 30, 0);
                previewUtility.m_Light[1].intensity = 0;
                previewUtility.m_Light[1].transform.rotation = quaternion;
            }
            else if (light == 1)
            {
                previewUtility.m_Light[0].intensity = 0.5f;
                previewUtility.m_Light[0].color = new Color(0.7f, 0.6f, 0.2f);
                previewUtility.m_Light[0].transform.rotation = quaternion * Quaternion.Euler(50, 50, 0);
                previewUtility.m_Light[1].intensity = 0.5f;
                previewUtility.m_Light[1].color = new Color(0.1f, 0.2f, 0.4f);
                previewUtility.m_Light[1].transform.rotation = quaternion;
            }
            else
            {
                previewUtility.m_Light[0].intensity = 0.5f;
                previewUtility.m_Light[0].color = Color.red;
                previewUtility.m_Light[0].transform.rotation = quaternion * Quaternion.Euler(0, 50, 0);
                previewUtility.m_Light[1].intensity = 0.5f;
                previewUtility.m_Light[1].color = Color.green;
                previewUtility.m_Light[1].transform.rotation = quaternion * Quaternion.Euler(50, 0, 0);
            }
