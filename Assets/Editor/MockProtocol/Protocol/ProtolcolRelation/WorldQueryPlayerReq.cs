...
namespace Mock.Protocol
{
	...
	/// </summary>
	[AdvancedInspector.Descriptor(" 查询玩家信息（可根据角色ID和名字查询，优先使用角色ID）", " 查询玩家信息（可根据角色ID和名字查询，优先使用角色ID）")]
	public class WorldQueryPlayerReq : global::UnityEngine.ScriptableObject, global::Mock.Protocol.IMockProtocol, global::Protocol.IProtocolStream, global::Protocol.IGetMsgID
	{
