...
namespace GameClient
{
    ...
    public class FrameClassName : GameFrame
    {
        ...
        protected override void _bindExUI()
        {
            ...
            testTxt = mBind.GetCom<TextEx>("testTxt");

            testBtn = mBind.GetCom<ButtonEx>("testBtn");
            testBtn.SafeSetOnClickListener(() => 
            {

            });

            testImg = mBind.GetCom<ImageEx>("testImg");
            ...
            testToggle = mBind.GetCom<ToggleEx>("testToggle");
