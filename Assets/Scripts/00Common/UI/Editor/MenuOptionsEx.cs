...
namespace UnityEditor.UI
{
    ...
    static internal class MenuOptionsEx
    {
        ...
        static private DefaultControlsEx.Resources s_StandardResources;

        static private DefaultControlsEx.Resources GetStandardResources()
        {
        ...
        {
            GameObject go = DefaultControlsEx.CreateText(GetStandardResources());
        ...
        {
            GameObject go = DefaultControlsEx.CreateImage(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }

        [MenuItem("GameObject/UI/NullImage", false, 2001)]
        static public void AddNullImage(MenuCommand menuCommand)
        {
            GameObject go = DefaultControlsEx.CreateNullImage(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
        ...
        {
            GameObject go = DefaultControlsEx.CreateRawImage(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
        ...
        {
            GameObject go = DefaultControlsEx.CreateButton(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
        ...
        {
            GameObject go = DefaultControlsEx.CreateToggle(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
        ...
        {
            GameObject go = DefaultControlsEx.CreateSlider(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
        ...
        {
            GameObject go = DefaultControlsEx.CreateScrollbar(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
        ...
        {
            GameObject go = DefaultControlsEx.CreateDropdown(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
        ...
        {
            GameObject go = DefaultControlsEx.CreateInputField(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
        ...
        {
            GameObject go = DefaultControlsEx.CreatePanel(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        ...
        {
            GameObject go = DefaultControlsEx.CreateScrollView(GetStandardResources());
            PlaceUIElementRoot(go, menuCommand);
        }
