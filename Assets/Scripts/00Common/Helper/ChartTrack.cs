...
public class ChartTrack
{
    ...
    {
        DrawingHandle.DrawLine(new Vector2(InStart.x + (Screen.width * Clip), (Screen.height * (1f - Clip)) - InStart.y), new Vector2(InEnd.x + (Screen.width * Clip), (Screen.height * (1f - Clip)) - InEnd.y), InColor, InWidth, true);
    }
