...
{
    public enum UserAgreementFrameType
    {
        LookInfo = 0,
        FirstOpen,
    }

    public struct UserAgreementFrameData
    {
        public UserAgreementFrameType frameType;
        public string PlatFormType;
        public string OpenUid;
    }

    // 控制弹出公告的开关在HotUpdateDownloader.cs文件，由usrAgreementString解析出来，通过ClientSystemLogin.mOpenUserAgreement控制，由BaseWaitHttpRequest请求返回得到
    public class UserAgreementFrame : ClientFrame
    {
        ...
        private void _onBtAcceptButtonClick()
        {
            ...
            ClientSystemManager.instance.OpenFrame<SecretAgreementFrame>(FrameLayer.Middle, data);
