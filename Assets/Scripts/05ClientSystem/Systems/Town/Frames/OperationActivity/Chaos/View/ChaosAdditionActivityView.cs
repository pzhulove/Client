...
namespace GameClient
{
    public class ChaosAdditionActivityView : MonoBehaviour, IDungeonBuffView
    {
        ...
        void InitItems(ILimitTimeActivityModel model)
        {
            ...
            if (mItemLeftGo.GetComponent<ChaosAddtionItem>() == null)
            {
            ...
            GameObject mItemRightGo = AssetLoader.GetInstance().LoadResAsGameObject(mChaosAddtionItemItemRightPath);
            ...
            if (mItemRightGo.GetComponent<ChaosAddtionItem>() == null)
            {
        ...
        void AddItem(GameObject go, int id, int index)
        {
            ...
            var script = item.GetComponent<ChaosAddtionItem>();
            if (script != null)
            {
                script.Init(id);
            }
