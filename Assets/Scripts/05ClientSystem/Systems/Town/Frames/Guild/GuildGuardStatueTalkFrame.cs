...
{
    class GuildGuardStatueTalkFrame : ClientFrame
    {
        byte StatueType = 0;
        ...
        protected override void _OnOpenFrame()
        {
            ...
            List<FigureStatueInfo> StatueInfoList = GuildDataManager.GetInstance().GetGuildGuardStatueInfo();
            ...
            for(int i = 0; i < StatueInfoList.Count; i++)
            {
                ...
                if (StatueInfo.statueType <= 0)
                {
                    ...
                    mTalkContent.text = TR.Value("Guild_Guard_Statue_No_Talk");
                    mNpcName.text = "";
                }
                else
                {
                    ...
                    mTalkContent.text = TR.Value("Guild_Guard_Statue_Talk");
