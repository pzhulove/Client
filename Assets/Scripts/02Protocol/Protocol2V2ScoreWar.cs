...
namespace Protocol
{
	...
	/// </summary>
	[Protocol]
	public class Scene2V2ScoreWarRewardReq : Protocol.IProtocolStream, Protocol.IGetMsgID
	{
	...
	/// </summary>
	[Protocol]
	public class Scene2V2coreWarRewardRes : Protocol.IProtocolStream, Protocol.IGetMsgID
	{
	...
	/// </summary>
	[Protocol]
	public class Scene2V2SyncScoreWarInfo : Protocol.IProtocolStream, Protocol.IGetMsgID
	{
