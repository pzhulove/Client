...
public enum eCrypt : int
{
 code = 2000239930,
  ...
  public static ChiJiShopItemTable GetRootAsChiJiShopItemTable(ByteBuffer _bb) { return GetRootAsChiJiShopItemTable(_bb, new ChiJiShopItemTable()); }
  public static ChiJiShopItemTable GetRootAsChiJiShopItemTable(ByteBuffer _bb, ChiJiShopItemTable obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p.bb_pos = _i; __p.bb = _bb; }
  public ChiJiShopItemTable __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public ProtoTable.ChiJiShopItemTable.eSubType SubType { get { int o = __p.__offset(16); return o != 0 ? (ProtoTable.ChiJiShopItemTable.eSubType)__p.bb.GetInt(o + __p.bb_pos) : ProtoTable.ChiJiShopItemTable.eSubType.ST_NONE; } }
  ...
  public static Offset<ChiJiShopItemTable> CreateChiJiShopItemTable(FlatBufferBuilder builder,
      ...
      int ItemID = 0,
      int SortID = 0,
      ProtoTable.ChiJiShopItemTable.eSubType SubType = ProtoTable.ChiJiShopItemTable.eSubType.ST_NONE,
      int CostItemID = 0,
      int CostNum = 0,
  ...
  public static void StartChiJiShopItemTable(FlatBufferBuilder builder) { builder.StartObject(30); }
  ...
  public static void AddSubType(FlatBufferBuilder builder, ProtoTable.ChiJiShopItemTable.eSubType SubType) { builder.AddInt(6, (int)SubType, 0); }
  ...
  public static Offset<ChiJiShopItemTable> EndChiJiShopItemTable(FlatBufferBuilder builder) {
    ...
    return new Offset<ChiJiShopItemTable>(o);
  }
  public static void FinishChiJiShopItemTableBuffer(FlatBufferBuilder builder, Offset<ChiJiShopItemTable> offset) { builder.Finish(offset.Value); }
};
