...
public enum eCrypt : int
{
 code = 182865018,
  ...
  public ProtoTable.ShopTable.eShopKind ShopKind { get { int o = __p.__offset(16); return o != 0 ? (ProtoTable.ShopTable.eShopKind)__p.bb.GetInt(o + __p.bb_pos) : ProtoTable.ShopTable.eShopKind.SK_Ancient; } }
 ...
 public FlatBufferArray<int>  Children
 {
  ...
  public ProtoTable.ShopTable.eFilter FilterArray(int j) { int o = __p.__offset(26); return o != 0 ? (ProtoTable.ShopTable.eFilter)__p.bb.GetInt(__p.__vector(o) + j * 4) : (ProtoTable.ShopTable.eFilter)0; }
 ...
 private FlatBufferArray<ProtoTable.ShopTable.eFilter> FilterValue;
 public FlatBufferArray<ProtoTable.ShopTable.eFilter>  Filter
 {
  get{
  if (FilterValue == null)
  {
    FilterValue = new FlatBufferArray<ProtoTable.ShopTable.eFilter>(this.FilterArray, this.FilterLength);
  }
  return FilterValue;}
 }
 ...
 public FlatBufferArray<int>  IsShowFilterTitle
 {
  ...
  public ProtoTable.ShopTable.eSubType SubTypeArray(int j) { int o = __p.__offset(34); return o != 0 ? (ProtoTable.ShopTable.eSubType)__p.bb.GetInt(__p.__vector(o) + j * 4) : (ProtoTable.ShopTable.eSubType)0; }
 ...
 private FlatBufferArray<ProtoTable.ShopTable.eSubType> SubTypeValue;
 public FlatBufferArray<ProtoTable.ShopTable.eSubType>  SubType
 {
  get{
  if (SubTypeValue == null)
  {
    SubTypeValue = new FlatBufferArray<ProtoTable.ShopTable.eSubType>(this.SubTypeArray, this.SubTypeLength);
  }
  return SubTypeValue;}
 }
 ...
 public FlatBufferArray<int>  NeedRefreshTabs
 {
  ...
  public ProtoTable.ShopTable.eRefreshCycle RefreshCycleArray(int j) { int o = __p.__offset(42); return o != 0 ? (ProtoTable.ShopTable.eRefreshCycle)__p.bb.GetInt(__p.__vector(o) + j * 4) : (ProtoTable.ShopTable.eRefreshCycle)0; }
 ...
 private FlatBufferArray<ProtoTable.ShopTable.eRefreshCycle> RefreshCycleValue;
 public FlatBufferArray<ProtoTable.ShopTable.eRefreshCycle>  RefreshCycle
 {
  get{
  if (RefreshCycleValue == null)
  {
    RefreshCycleValue = new FlatBufferArray<ProtoTable.ShopTable.eRefreshCycle>(this.RefreshCycleArray, this.RefreshCycleLength);
  }
 ...
 public FlatBufferArray<int>  RefreshTime
 {
  ...
  public ProtoTable.ShopTable.eSubTypeOrder SubTypeOrderArray(int j) { int o = __p.__offset(52); return o != 0 ? (ProtoTable.ShopTable.eSubTypeOrder)__p.bb.GetInt(__p.__vector(o) + j * 4) : (ProtoTable.ShopTable.eSubTypeOrder)0; }
 ...
 private FlatBufferArray<ProtoTable.ShopTable.eSubTypeOrder> SubTypeOrderValue;
 public FlatBufferArray<ProtoTable.ShopTable.eSubTypeOrder>  SubTypeOrder
 {
  get{
  if (SubTypeOrderValue == null)
  {
    SubTypeOrderValue = new FlatBufferArray<ProtoTable.ShopTable.eSubTypeOrder>(this.SubTypeOrderArray, this.SubTypeOrderLength);
  }
 ...
 public FlatBufferArray<int>  VIPDiscount
 {
  ...
  public ProtoTable.ShopTable.eBindType BindType { get { int o = __p.__offset(76); return o != 0 ? (ProtoTable.ShopTable.eBindType)__p.bb.GetInt(o + __p.bb_pos) : ProtoTable.ShopTable.eBindType.ROLE_BIND; } }
 ...
 public FlatBufferArray<string>  CurrencyExtraItem
 {
  ...
  public int ShowExchangeCoinItemArray(int j) { int o = __p.__offset(86); return o != 0 ? (int)eCrypt.code^__p.bb.GetInt(__p.__vector(o) + j * 4) : (int)0; }
  public int ShowExchangeCoinItemLength { get { int o = __p.__offset(86); return o != 0 ? __p.__vector_len(o) : 0; } }
  public ArraySegment<byte>? GetShowExchangeCoinItemBytes() { return __p.__vector_as_arraysegment(86); }
 private FlatBufferArray<int> ShowExchangeCoinItemValue;
 public FlatBufferArray<int>  ShowExchangeCoinItem
 {
  get{
  if (ShowExchangeCoinItemValue == null)
  {
    ShowExchangeCoinItemValue = new FlatBufferArray<int>(this.ShowExchangeCoinItemArray, this.ShowExchangeCoinItemLength);
  }
  return ShowExchangeCoinItemValue;}
 }
  ...
  public static Offset<ShopTable> CreateShopTable(FlatBufferBuilder builder,
      ...
      ProtoTable.ShopTable.eShopKind ShopKind = ProtoTable.ShopTable.eShopKind.SK_Ancient,
      int HelpID = 0,
      int Param1 = 0,
      int IsGuildShop = 0,
      ...
      ProtoTable.ShopTable.eBindType BindType = ProtoTable.ShopTable.eBindType.ROLE_BIND,
      int HonorDiscount = 0,
      ...
      VectorOffset ShowExchangeCoinItemOffset = default(VectorOffset)) {
    builder.StartObject(42);
    ShopTable.AddShowExchangeCoinItem(builder, ShowExchangeCoinItemOffset);
  ...
  public static void StartShopTable(FlatBufferBuilder builder) { builder.StartObject(42); }
  ...
  public static void AddShopKind(FlatBufferBuilder builder, ProtoTable.ShopTable.eShopKind ShopKind) { builder.AddInt(6, (int)ShopKind, 0); }
  ...
  public static VectorOffset CreateFilterVector(FlatBufferBuilder builder, ProtoTable.ShopTable.eFilter[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  ...
  public static VectorOffset CreateSubTypeVector(FlatBufferBuilder builder, ProtoTable.ShopTable.eSubType[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  ...
  public static VectorOffset CreateRefreshCycleVector(FlatBufferBuilder builder, ProtoTable.ShopTable.eRefreshCycle[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  ...
  public static VectorOffset CreateSubTypeOrderVector(FlatBufferBuilder builder, ProtoTable.ShopTable.eSubTypeOrder[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt((int)data[i]); return builder.EndVector(); }
  ...
  public static void AddBindType(FlatBufferBuilder builder, ProtoTable.ShopTable.eBindType BindType) { builder.AddInt(36, (int)BindType, 0); }
  ...
  public static void AddShowExchangeCoinItem(FlatBufferBuilder builder, VectorOffset ShowExchangeCoinItemOffset) { builder.AddOffset(41, ShowExchangeCoinItemOffset.Value, 0); }
  public static VectorOffset CreateShowExchangeCoinItemVector(FlatBufferBuilder builder, int[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddInt(data[i]); return builder.EndVector(); }
  public static void StartShowExchangeCoinItemVector(FlatBufferBuilder builder, int numElems) { builder.StartVector(4, numElems, 4); }
