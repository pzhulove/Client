...
public enum eCrypt : int
{
 code = 114988718,
  ...
  public static GiftTable GetRootAsGiftTable(ByteBuffer _bb) { return GetRootAsGiftTable(_bb, new GiftTable()); }
  public static GiftTable GetRootAsGiftTable(ByteBuffer _bb, GiftTable obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p.bb_pos = _i; __p.bb = _bb; }
  public GiftTable __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
 ...
 public FlatBufferArray<int>  Levels
 {
  ...
  public static Offset<GiftTable> CreateGiftTable(FlatBufferBuilder builder,
      int ID = 0,
      int ItemID = 0,
      int GiftPackID = 0,
      int ItemCount = 0,
  ...
  public static void StartGiftTable(FlatBufferBuilder builder) { builder.StartObject(9); }
  ...
  public static Offset<GiftTable> EndGiftTable(FlatBufferBuilder builder) {
    ...
    return new Offset<GiftTable>(o);
  }
  public static void FinishGiftTableBuffer(FlatBufferBuilder builder, Offset<GiftTable> offset) { builder.Finish(offset.Value); }
};
