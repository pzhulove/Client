...
public enum eCrypt : int
{
 code = 1747873531,
  ...
  public static ScoreWar2v2RewardTable GetRootAsScoreWar2v2RewardTable(ByteBuffer _bb) { return GetRootAsScoreWar2v2RewardTable(_bb, new ScoreWar2v2RewardTable()); }
  public static ScoreWar2v2RewardTable GetRootAsScoreWar2v2RewardTable(ByteBuffer _bb, ScoreWar2v2RewardTable obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p.bb_pos = _i; __p.bb = _bb; }
  public ScoreWar2v2RewardTable __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
 ...
 public FlatBufferArray<string>  RewardPreview
 {
  ...
  public static Offset<ScoreWar2v2RewardTable> CreateScoreWar2v2RewardTable(FlatBufferBuilder builder,
      int ID = 0,
      int RewardId = 0,
      int BattleCount = 0,
      int WinCount = 0,
  ...
  public static void StartScoreWar2v2RewardTable(FlatBufferBuilder builder) { builder.StartObject(8); }
  ...
  public static Offset<ScoreWar2v2RewardTable> EndScoreWar2v2RewardTable(FlatBufferBuilder builder) {
    ...
    return new Offset<ScoreWar2v2RewardTable>(o);
  }
  public static void FinishScoreWar2v2RewardTableBuffer(FlatBufferBuilder builder, Offset<ScoreWar2v2RewardTable> offset) { builder.Finish(offset.Value); }
};
